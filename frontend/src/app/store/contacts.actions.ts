...
export const addContactError = createAction('[Contact List] Add Contact Error');
...
export const deleteContactError = createAction('[Contact List] Delete Contact Error');
...
export const updateContactError = createAction('[Contact List] Update Contact Error');
